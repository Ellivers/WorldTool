...
execute as @e[type=minecraft:item,tag=!global.ignore,nbt={Item:{components:{"minecraft:custom_data":{WorldTool:{Droppable:1b}}}},PickupDelay:40s,OnGround:0b},sort=nearest,limit=1] run function worldtool:drop_tool/check
