...
execute as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_clone_preview_pos1,tag=outline_load,limit=1] run function worldtool:particles/clone_preview/position/get_pos2
