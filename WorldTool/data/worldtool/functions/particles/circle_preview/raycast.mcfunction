...
execute if entity @s[tag=up] run particle minecraft:dust 0.671 0.161 0.875 1.5 ~ ~ ~ 0 .3 0 2 3 force
execute if entity @s[tag=north] run particle minecraft:dust 0.671 0.161 0.875 1.5 ~ ~ ~ 0 0 .3 2 3 force
execute if entity @s[tag=east] run particle minecraft:dust 0.671 0.161 0.875 1.5 ~ ~ ~ .3 0 0 2 3 force
