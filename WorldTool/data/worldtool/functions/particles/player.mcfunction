...
execute unless entity @s[tag=!wt.menu.randomize.set_source.pos1,tag=!wt.menu.randomize.set_source.pos2,tag=!wt.menu.randomize.set_source.confirm,tag=!wt.menu.randomize] run function worldtool:particles/randomization_source_selection/display
