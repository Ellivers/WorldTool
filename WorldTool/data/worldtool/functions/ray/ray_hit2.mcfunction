...
execute if score $forceLoadPositions worldtool matches 1.. store success score @e[type=minecraft:area_effect_cloud,tag=pos2,sort=nearest,limit=1] worldtool run forceload add ~ ~
