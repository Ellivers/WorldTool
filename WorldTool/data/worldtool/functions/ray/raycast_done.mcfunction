...
execute if entity @s[tag=wt_random_1] run function worldtool:ray/ray_hit_r1
execute if entity @s[tag=wt_random_2] run function worldtool:ray/ray_hit_r2
...
execute if entity @s[tag=wt_pick_block_tool] run function worldtool:pick_block/pick_block
