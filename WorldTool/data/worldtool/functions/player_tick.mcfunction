...
execute unless entity @s[tag=!check_block_brush,tag=!check_block_replacebrush,tag=!check_brush_structure,tag=!check_brush_structure_offset] run function worldtool:block_check/player
