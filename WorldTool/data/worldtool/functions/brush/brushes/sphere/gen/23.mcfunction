...
execute if predicate worldtool:brush/hollow run setblock ~ ~ ~ minecraft:structure_block{name:"worldtool:spheres/sphere_21_air",posX:-10,posY:-10,posZ:-10,mode:LOAD}
