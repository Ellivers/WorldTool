...
execute if predicate worldtool:brush/hollow run setblock ~ ~ ~ minecraft:structure_block{name:"worldtool:spheres/sphere_11_air",posX:-5,posY:-5,posZ:-5,mode:LOAD}
