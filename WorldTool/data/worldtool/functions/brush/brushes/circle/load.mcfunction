# Called by worldtool:brush/brushes/circle/loadcheck
...
summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["scheduled_circle","worldtool"]}
