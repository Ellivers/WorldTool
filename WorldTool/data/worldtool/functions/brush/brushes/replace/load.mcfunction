...
execute unless entity @s[tag=brush_replace_air] run summon falling_block 2 1 13 {Time:-34}
execute unless entity @s[tag=brush_replace_air] positioned 2 1 13 run data modify entity @e[type=minecraft:falling_block,sort=nearest,limit=1] BlockState set from entity @s SelectedItem.tag.ReplaceBlock
