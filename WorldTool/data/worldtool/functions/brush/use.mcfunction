...
execute unless entity @s[predicate=!worldtool:brushes/color,predicate=!worldtool:brushes/place,predicate=!worldtool:brushes/paint,predicate=!worldtool:brushes/replace,predicate=!worldtool:brushes/flat_paint,predicate=!worldtool:brushes/flat_place] if entity @e[type=minecraft:area_effect_cloud,tag=wt_drawer] run tellraw @s {"text": "Another process is currently running","color":"red"}

#The different brushes, including picking (grabing) a block
execute unless entity @s[predicate=!worldtool:brushes/place,predicate=!worldtool:brushes/paint,predicate=!worldtool:brushes/flat_place,predicate=!worldtool:brushes/flat_paint] unless entity @e[type=minecraft:area_effect_cloud,tag=wt_drawer] run function worldtool:brush/brushes/paint/main
