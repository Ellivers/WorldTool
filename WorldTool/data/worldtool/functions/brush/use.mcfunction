...
execute if entity @s[tag=!grabbing_block] unless entity @s[predicate=!worldtool:brushes/flat_place,predicate=!worldtool:brushes/flat_paint] unless entity @e[type=minecraft:area_effect_cloud,tag=wt_drawer] run function worldtool:brush/brushes/flat/load1
