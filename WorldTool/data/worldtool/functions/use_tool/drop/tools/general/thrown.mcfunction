...
execute if data storage worldtool:storage Temp.Item.tag.WorldTool{Tool:"general",Controls:"worldtool:limited"} as @p[scores={wt.drop_coas=1..}] at @s[scores={wt.sneak=1..}] run function worldtool:ui_general/click/load
