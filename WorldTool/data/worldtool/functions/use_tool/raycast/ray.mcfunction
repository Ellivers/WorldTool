...
execute if score #raycastComplete worldtool matches 0 unless score #temp worldtool >= #temp2 worldtool positioned ^ ^ ^.5 if block ~ ~ ~ #worldtool:air run function worldtool:use_tool/raycast/ray
