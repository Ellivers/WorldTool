...
summon minecraft:shulker ~ ~ ~ {ActiveEffects:[{Id:14,Duration:2147483647,ShowParticles:0b}],NoAI:1b,Glowing:1b,Invulnerable:1b,DeathLootTable:"minecraft:empty",Tags:["worldtool","wt.highlight_entity","wt.temp"]}
