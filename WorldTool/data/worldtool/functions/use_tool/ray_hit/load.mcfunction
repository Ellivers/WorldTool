...
execute if entity @s[tag=wt.tool.shapes,tag=!wt.pick_block.other,predicate=!worldtool:shape_tool/settings/continuous_place] run function worldtool:use_tool/ray_hit/shape_tool_pos
execute if entity @s[tag=wt.tool.shapes,tag=!wt.pick_block.other,predicate=worldtool:shape_tool/settings/continuous_place] run function worldtool:use_shapes/continuous
