...
execute if score #success worldtool matches 1 if score $processRunning worldtool matches 1.. run data modify storage worldtool:storage Temp.LogEntry set value '{"nbt":"Translation.\\"info.log.process_already_running.cancel\\"","storage":"worldtool:storage","interpret":true}'
