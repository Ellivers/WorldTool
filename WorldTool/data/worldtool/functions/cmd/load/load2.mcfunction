...
execute unless entity @s[tag=wt_clone] run kill @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos]
execute unless entity @s[tag=wt_clone] run kill 35c1ab68-9d4c-11eb-a8b3-0242ac130003
execute unless entity @s[tag=wt_clone] run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["from_cmd","ticking","worldtool"], UUID:[I; 901884776, -1655959061, -1464663486, -1408040957]}
...
execute if entity @s[tag=wt_clone] run function worldtool:cmd/load/load_clone1
...
execute if entity @s[tag=!wt_clone,tag=!random1] run schedule function worldtool:process_load/load2_fill 1t