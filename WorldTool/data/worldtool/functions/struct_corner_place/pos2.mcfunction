...
execute store result score @s pos2x run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=pos1,tag=wt_struct_corn,limit=1] Pos[0]
execute store result score @s pos2y run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=pos1,tag=wt_struct_corn,limit=1] Pos[1]
execute store result score @s pos2z run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=pos1,tag=wt_struct_corn,limit=1] Pos[2]
