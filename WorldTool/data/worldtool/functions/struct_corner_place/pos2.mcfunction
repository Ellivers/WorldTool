...
execute store result score @s wt_pos2x run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_struct_corn1,limit=1] Pos[0]
execute store result score @s wt_pos2y run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_struct_corn1,limit=1] Pos[1]
execute store result score @s wt_pos2z run data get entity @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_struct_corn1,limit=1] Pos[2]
...
tag @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_struct_corn1] remove wt_struct_corn1
tag @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_struct_corn2] remove wt_struct_corn2
