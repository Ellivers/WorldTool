...
execute if entity @s[tag=wt.process.save_area] as @a if score @s wt.ID = #ID_temp worldtool run function worldtool:technical/common/save_load_area/area_saved
