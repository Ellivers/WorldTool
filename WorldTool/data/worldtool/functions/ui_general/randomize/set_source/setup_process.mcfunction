...
data modify storage worldtool:storage Processes prepend value {DisplayName:'{"nbt":"Translation.\\"process.randomization_source\\"","storage":"worldtool:storage"}',Id:"worldtool:randomization_source",Tags:["wt.process.randomization_source","wt.no_message"]}
