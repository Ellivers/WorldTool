...
execute if entity @s[tag=placing_filtered] run function worldtool:ui_general/menus/clone/filter/select_filtered.normal
execute if entity @s[tag=placing_filtered_reversed] run function worldtool:ui_general/menus/clone/filter/select_filtered.reversed
