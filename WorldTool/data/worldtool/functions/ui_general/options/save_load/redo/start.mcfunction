...
function worldtool:ui_general/options/save_load/redo/move_history

execute if score #temp2 worldtool matches 0 run function worldtool:ui_general/options/save_load/redo/move_history
...
execute if score #temp6 worldtool matches 1 run function worldtool:ui_general/options/save_load/redo/move_history
