...
execute store result score #sizeX worldtool run data get storage rx.playerdb:io player.data.WorldTool.Clipboard[0].Size[0]
execute store result score #sizeY worldtool run data get storage rx.playerdb:io player.data.WorldTool.Clipboard[0].Size[1]
execute store result score #sizeZ worldtool run data get storage rx.playerdb:io player.data.WorldTool.Clipboard[0].Size[2]
