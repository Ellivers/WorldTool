...
summon minecraft:armor_stand ^ ^-.5 ^1.5 {Invisible:1b,Tags:["worldtool","wt.particles","wt.rotation_preview","smithed.strict"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:observer",Count:1b}],Pose:{Head:[0f,1f,0f]}}
