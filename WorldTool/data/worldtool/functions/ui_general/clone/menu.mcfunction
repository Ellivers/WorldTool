...
tellraw @s[tag=wt.clone.mode.standard] {"nbt":"Translation.\"button.clone.mode.standard\"","storage": "worldtool:storage","color": "green","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.clone.mode.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/clone/select_mode/menu"}}
tellraw @s[tag=wt.clone.mode.structure] {"nbt":"Translation.\"button.clone.mode.structure\"","storage": "worldtool:storage","color": "green","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.clone.mode.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/clone/select_mode/menu"}}
