...
execute if data storage worldtool:storage Temp.Process{Tags:["wt.process.save_area.back_up"]} run data modify storage worldtool:storage Processes[-3].Input.AreaData.TemplateList set from storage worldtool:storage Processes[-1].Output.TemplateList
execute unless data storage worldtool:storage Temp.Process{Tags:["wt.process.save_area.back_up"]} run data modify storage worldtool:storage Processes[-2].Input.AreaData.TemplateList set from storage worldtool:storage Processes[-1].Output.TemplateList
