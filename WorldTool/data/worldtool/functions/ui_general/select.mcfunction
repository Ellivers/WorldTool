...
execute as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=pos1] if score @s wt_ID = #ID_temp worldtool run function worldtool:ui_general/select.pos1
...
function worldtool:ui_general/clone/remove_preview
