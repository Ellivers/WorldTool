...
tellraw @s ["",{"text": "[⬅Back]\n","color":"yellow","hoverEvent": {"action": "show_text","value": "Go back"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/settings"}},{"text": "Maximum blocks per tick","bold": true,"color":"green"}]

function worldtool:ui_general/menus/options/bpt/get

tellraw @s "\n\n"
execute if entity @s[tag=wt_customBPT] run tellraw @s [{"text": "Preset: ","color":"aqua"},{"text": "< ","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Maximum"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/max"}},{"text": "Custom","color":"gold"},{"text": " >","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Low"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/low"}}]
execute if entity @s[tag=wt_maximumBPT] run tellraw @s [{"text": "Preset: ","color":"aqua"},{"text": "< ","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "High"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/high"}},{"text": "Maximum","color":"gold"},{"text": " >","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Low"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/low"}}]
execute if entity @s[tag=wt_highBPT] run tellraw @s [{"text": "Preset: ","color":"aqua"},{"text": "< ","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Medium"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/medium"}},{"text": "High (default)","color":"gold"},{"text": " >","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Maximum"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/max"}}]
execute if entity @s[tag=wt_mediumBPT] run tellraw @s [{"text": "Preset: ","color":"aqua"},{"text": "< ","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Low"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/low"}},{"text": "Medium","color":"gold"},{"text": " >","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "High"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/high"}}]
execute if entity @s[tag=wt_lowBPT] run tellraw @s [{"text": "Preset: ","color":"aqua"},{"text": "< ","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Maximum"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/max"}},{"text": "Low","color":"gold"},{"text": " >","color":"light_purple","bold": true,"hoverEvent": {"action": "show_text","value": "Medium"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/bpt/medium"}}]
tellraw @s "\n"
