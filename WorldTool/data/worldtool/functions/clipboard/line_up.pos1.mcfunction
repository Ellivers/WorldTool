...
#execute if score #tempPos2X worldtool > #tempPos1X worldtool run scoreboard players add #tempPosDest1X worldtool 1
#execute if score #tempPos2Y worldtool > #tempPos1Y worldtool run scoreboard players add #tempPosDest1Y worldtool 1
#execute if score #tempPos2Z worldtool > #tempPos1Z worldtool run scoreboard players add #tempPosDest1Z worldtool 1
