...
# Separated from the others because this detects entities instead of blocks

execute if entity @s[tag=wt.menu.adjust_positions] if entity @e[type=minecraft:item,tag=worldtool,tag=wt.selected_data,distance=..1] run function worldtool:ui_general/options/adjust_positions/data_input/load
...
execute if entity @s[tag=wt.menu.smooth.settings] if entity @e[type=minecraft:item,tag=worldtool,tag=wt.selected_data,distance=..1] run function worldtool:ui_general/smooth/settings/edge_detection_limit_set
execute if entity @s[tag=wt.menu.structure_corners] if entity @e[type=minecraft:item,tag=worldtool,tag=wt.selected_data,distance=..1] run function worldtool:ui_general/structure_corners/set_name
...
execute if entity @s[tag=wt.menu.shapes.adjust_position] if entity @e[type=minecraft:item,tag=worldtool,tag=wt.selected_data,distance=..1] run function worldtool:ui_shapes/adjust_position/data_input/load
