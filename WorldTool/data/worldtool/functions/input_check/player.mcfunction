...
execute if entity @s[tag=wt.select_block.brush] if entity @e[type=minecraft:falling_block,tag=worldtool,tag=wt.selected_block,distance=..1] run function worldtool:ui/select_block/selected/from_chat
