...
execute if entity @s[tag=wt.menu.shell.side_settings] if entity @e[type=minecraft:item,tag=worldtool,tag=wt.selected_data,distance=..1] run function worldtool:ui_general/shell/side_settings/set_size
