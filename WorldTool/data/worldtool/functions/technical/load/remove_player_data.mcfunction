...
# execute if data storage rx.playerdb:main players[0].data.WorldTool.Clipboard run function worldtool:technical/common/save_load/restock_slots
...
# execute if data storage rx.playerdb:main players[0].data.WorldTool.Current run function worldtool:technical/common/save_load/restock_slots
...
# execute if data storage rx.playerdb:main players[0].data.WorldTool.History[0] run function worldtool:technical/common/save_load/restock_from_area_list
...
# execute if data storage rx.playerdb:main players[0].data.WorldTool.Future[0] run function worldtool:technical/common/save_load/restock_from_area_list
