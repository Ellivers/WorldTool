...
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:greenery"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:greenery",Value:3000,Presets:{Low:600,Medium:1500,High:3000}}
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:greenery_brush"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:greenery_brush",Value:4000,Presets:{Low:600,Medium:2000,High:4000}}
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:shatter"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:shatter",Value:4000,Presets:{Low:600,Medium:2000,High:4000}}
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:repeat"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:repeat",Value:4000,Presets:{Low:600,Medium:2000,High:4000}}
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:smooth"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:smooth",Value:3000,Presets:{Low:600,Medium:1500,High:3000}}
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:command_list"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:command_list",Value:4000,Presets:{Low:600,Medium:2000,High:4000}}
...
execute unless data storage worldtool:storage BlocksPerTick.Processes[{ID:"worldtool:2d_fill"}] run data modify storage worldtool:storage BlocksPerTick.Processes append value {ID:"worldtool:2d_fill",Value:2000,Presets:{Low:600,Medium:1500,High:2000}}
