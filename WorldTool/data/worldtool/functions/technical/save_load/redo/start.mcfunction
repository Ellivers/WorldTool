...
execute if score #temp worldtool matches 2.. run data modify storage worldtool:storage Temp.Pos set from storage rx.playerdb:io player.data.WorldTool.Future[0][0].Pos
execute if score #temp worldtool matches 2.. store result score #temp2 worldtool run data modify storage worldtool:storage Temp.Pos set from storage rx.playerdb:io player.data.WorldTool.Future[1][0].Pos
execute if score #temp2 worldtool matches 0 run data modify storage worldtool:storage Temp.Size set from storage rx.playerdb:io player.data.WorldTool.Future[0][0].Size
execute if score #temp2 worldtool matches 0 store result score #temp2 worldtool run data modify storage worldtool:storage Temp.Size set from storage rx.playerdb:io player.data.WorldTool.Future[1][0].Size
...
execute if score #temp worldtool matches 3.. if score #temp2 worldtool matches 0 store result score #temp3 worldtool run data modify storage worldtool:storage Temp.Pos set from storage rx.playerdb:io player.data.WorldTool.Future[2][0].Pos
execute if score #temp worldtool matches 3.. if score #temp2 worldtool matches 0 if score #temp3 worldtool matches 0 store result score #temp3 worldtool run data modify storage worldtool:storage Temp.Size set from storage rx.playerdb:io player.data.WorldTool.Future[2][0].Size
