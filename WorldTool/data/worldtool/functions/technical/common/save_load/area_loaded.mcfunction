...
execute if entity @s[tag=wt.process.load_area.clone] run data modify storage worldtool:storage Temp.TemplateList set from storage worldtool:storage Processes[-1].Input.AreaData.TemplateList
