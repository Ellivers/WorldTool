...
execute if score #output worldtool matches 8..9 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:processes/greenery/double_plants/tall_grass
execute if score #output worldtool matches 10 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:processes/greenery/double_plants/sunflower
