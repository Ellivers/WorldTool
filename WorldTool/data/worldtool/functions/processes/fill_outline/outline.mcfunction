...
execute if score $drawingposX worldtool < $pos2x worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/x
execute if score $drawingposX worldtool > $pos2x worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/-x

execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool < $pos2y worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/y
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool > $pos2y worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/-y

execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool = $pos2y worldtool if score $drawingposZ worldtool < $pos2z worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/z
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool = $pos2y worldtool if score $drawingposZ worldtool > $pos2z worldtool unless score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run function worldtool:processes/fill_outline/-z
...
#execute if score #blockschecked worldtool >= $outlinedBlocksPerTick worldtool run schedule function worldtool:process_load/load2_fill 1t