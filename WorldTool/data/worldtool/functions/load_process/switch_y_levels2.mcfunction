...
execute as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_drawer,sort=nearest,limit=1] store result entity @s Pos[1] double 1 run scoreboard players get $pos1y worldtool
