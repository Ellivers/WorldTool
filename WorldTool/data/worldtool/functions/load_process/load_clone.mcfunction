...
execute if entity @s[tag=!mirrorY] unless score @s rotX matches -90.. unless score @s rotZ matches -90.. if score $pos1y worldtool > $pos2y worldtool run function worldtool:load_process/switch_y_levels2
