...
execute unless entity @s[tag=!cloning_wt,tag=!hollow,tag=!random1,tag=!random2,tag=!foliage_ing,tag=!filling_outline] run function worldtool:load_process/load2_fill.tags1
