...
summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["randompoint"]}
scoreboard players operation @e[type=minecraft:area_effect_cloud,tag=randompoint] wt_ID = @s wt_ID
