...
execute unless block ~ ~ ~ #worldtool:air_blocks at @a if score @s wt_ID = @p wt_ID unless entity @p[tag=!placing_replace_foliage,tag=!placing_replace_foliage_reversed] as @p at @s run function worldtool:ui/foliage/replace/selected
