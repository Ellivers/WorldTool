...
execute as @e[type=minecraft:item,sort=nearest,limit=1] run function worldtool:ui/tool_shapes/select/grab_block.item
...
schedule function worldtool:ui/tool_shapes/tick_menu 1t
