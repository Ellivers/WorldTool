...
execute if predicate worldtool:shapes/cone unless score $functionRunning worldtool matches 1.. at @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_generation_marker,tag=wt_be_seelected] run function worldtool:generate_shape/cone/start
