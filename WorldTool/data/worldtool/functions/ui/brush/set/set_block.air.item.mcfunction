execute unless block ~ ~ ~ water run data modify entity @s Item.tag.Block.Name set value "minecraft:air"
execute if block ~ ~ ~ water run data modify entity @s Item.tag.Block.Name set value "minecraft:water"
