...
data modify storage worldtool:storage Processes append from storage worldtool:storage Processes[-1]
data remove storage worldtool:storage Processes[-1]

execute if score #temp2 worldtool = #temp worldtool run data remove storage worldtool:storage Processes[-1]
