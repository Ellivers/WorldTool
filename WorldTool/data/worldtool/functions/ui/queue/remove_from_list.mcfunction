...
data modify storage worldtool:storage NewProcesses append from storage worldtool:storage NewProcesses[0]
data remove storage worldtool:storage NewProcesses[0]

execute if score #temp2 worldtool = #temp worldtool run data remove storage worldtool:storage NewProcesses[0]
