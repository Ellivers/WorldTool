...
execute if score #temp worldtool matches 0 unless score $processRunning worldtool matches 1.. run function worldtool:process_start/common/start
execute if score #temp worldtool matches 0 run scoreboard players set #success worldtool 1

execute if score #success worldtool matches 0 unless score $processRunning worldtool matches 1.. run data remove storage worldtool:storage Processes[-1]
