...
execute if entity @s[tag=wt.replace.normal] run item modify entity @s weapon.mainhand worldtool:brush_tool/settings/replace/normal
execute if entity @s[tag=wt.replace.exclude] run item modify entity @s weapon.mainhand worldtool:brush_tool/settings/replace/exclude
...
execute if entity @s[tag=wt.select_block.other.replace] run item modify entity @s weapon.mainhand worldtool:set_secondary_block
