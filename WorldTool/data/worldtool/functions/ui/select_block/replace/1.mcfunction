...
execute unless entity @s[predicate=!worldtool:brush_tool/settings/replace/normal,predicate=!worldtool:shape_tool/settings/replace/normal] run tellraw @s [{"nbt":"Translation.\"info.selected_replace_block.normal\"","storage": "worldtool:storage"},{"nbt":"Temp.ItemData.WorldTool.SecondaryBlock.State.Name","storage": "worldtool:storage","color": "green"}]
execute unless entity @s[predicate=!worldtool:brush_tool/settings/replace/exclude,predicate=!worldtool:shape_tool/settings/replace/exclude] run tellraw @s [{"nbt":"Translation.\"info.selected_replace_block.exclude\"","storage": "worldtool:storage"},{"nbt":"Temp.ItemData.WorldTool.SecondaryBlock.State.Name","storage": "worldtool:storage","color": "green"}]
