...
execute if entity @s[tag=wt.menu.shatter.replace] run function worldtool:ui_general/shatter/start
execute if entity @s[tag=wt.brush.first_replace] run function worldtool:ui_brush/select_brush/replace/set
