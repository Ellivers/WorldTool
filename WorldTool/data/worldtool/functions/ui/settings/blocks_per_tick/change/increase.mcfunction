...
execute if score #temp worldtool matches 2147483647 run scoreboard players set #temp worldtool 500

execute if entity @s[tag=!wt.temp] run scoreboard players add #temp worldtool 500
