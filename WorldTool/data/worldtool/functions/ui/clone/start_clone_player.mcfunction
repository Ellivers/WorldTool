execute unless entity @e[type=minecraft:area_effect_cloud,tag=wt_drawer] run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["wt_drawer","ticking"]}
execute as @e[type=minecraft:area_effect_cloud,tag=wt_drawer] run tp @e[type=minecraft:area_effect_cloud,tag=pos1,limit=1]

execute unless entity @e[type=minecraft:area_effect_cloud,tag=clonepos] run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["clonepos"]}
...
execute as @e[type=minecraft:area_effect_cloud,tag=pos1] if score @s[distance=..200] wt_ID = @p wt_ID at @e[type=minecraft:area_effect_cloud,tag=wt_drawer,sort=nearest,limit=1] run function worldtool:load_fill
