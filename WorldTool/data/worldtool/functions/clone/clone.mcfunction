...
execute unless score #blockschecked worldtool >= $clonedBlocksPerTick worldtool at @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos] unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:clone/check_place
...
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposZ worldtool < $pos2z worldtool unless score #blockschecked worldtool >= $clonedBlocksPerTick worldtool run function worldtool:clone/z
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposZ worldtool > $pos2z worldtool unless score #blockschecked worldtool >= $clonedBlocksPerTick worldtool run function worldtool:clone/-z

execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposZ worldtool = $pos2z worldtool if score $drawingposY worldtool < $pos2y worldtool unless score #blockschecked worldtool >= $clonedBlocksPerTick worldtool run function worldtool:clone/y
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposZ worldtool = $pos2z worldtool if score $drawingposY worldtool > $pos2y worldtool unless score #blockschecked worldtool >= $clonedBlocksPerTick worldtool run function worldtool:clone/-y
