...
execute unless score @s rotZ matches 0 as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos] at @s run tp ~ ~ ~1

execute if score @s rotX matches 90 as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos] at @s run tp ~ ~-1 ~
execute if score @s rotX matches 180 as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos] at @s run tp ~ ~ ~-1
execute if score @s rotX matches -90 as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=clonepos] at @s run tp ~ ~1 ~
