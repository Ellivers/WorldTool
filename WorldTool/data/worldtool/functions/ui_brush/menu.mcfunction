...
execute if entity @s[tag=wt.setting.brush_size] run tellraw @s ["",{"nbt":"Translation.\"label.brush_size\"","storage": "worldtool:storage","color":"dark_aqua"},{"nbt":"Translation.\"button.decrease.name\"","storage": "worldtool:storage","color":"light_purple","bold":true,"hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush_size.decrease.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/settings/brush_size_decrease"}},{"score":{"name":"@s","objective":"wt.brush_size"}},{"nbt":"Translation.\"button.increase.name\"","storage": "worldtool:storage","color":"light_purple","bold":true,"hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush_size.increase.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/settings/brush_size_increase"}}]
...
execute if entity @s[tag=wt.setting.structure_rotation] run tellraw @s ["",{"nbt":"Translation.\"label.brush.structure_rotation.name\"","storage": "worldtool:storage","color": "gold","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"label.brush.structure_rotation.description\"","storage": "worldtool:storage"}}},{"nbt":"Translation.\"button.left.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.left.description\"","storage": "worldtool:storage"}},"clickEvent": {"action":"run_command","value": "/function worldtool:ui_brush/settings/structure_rot_cycle_left"}},{"score":{"name": "#structure_rot_temp","objective": "worldtool"},"color":"green"},{"nbt":"Translation.\"button.right.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.left.description\"","storage": "worldtool:storage"}},"clickEvent": {"action":"run_command","value": "/function worldtool:ui_brush/settings/structure_rot_cycle_right"}}]
execute if entity @s[tag=wt.setting.structure_mirror] run tellraw @s ["",{"nbt":"Translation.\"label.brush.structure_mirror.name\"","storage": "worldtool:storage","color": "dark_purple","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"label.brush.structure_mirror.description\"","storage": "worldtool:storage"}}},{"nbt":"Translation.\"button.left.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.left.description\"","storage": "worldtool:storage"}},"clickEvent": {"action":"run_command","value": "/function worldtool:ui_brush/settings/structure_mirror_left"}},{"nbt":"SelectedItem.tag.WorldTool.BrushSettings.StructureMirror","entity": "@s","color":"green"},{"nbt":"Translation.\"button.right.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.right.description\"","storage": "worldtool:storage"}},"clickEvent": {"action":"run_command","value": "/function worldtool:ui_brush/settings/structure_mirror_right"}}]
execute if entity @s[tag=wt.setting.structure_offset] run tellraw @s {"nbt":"Translation.\"button.brush.structure_offset.name\"","storage": "worldtool:storage","color": "dark_green","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.brush.structure_offset.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_brush/settings/structure_offset_menu"}}
...
execute if entity @s[tag=wt.brush.replace] run tellraw @s ["\n\n\n",{"nbt":"Translation.\"button.brush.select_block.name\"","storage": "worldtool:storage","color":"aqua","hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush.select_block.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/select_block/select"}},{"nbt":"Translation.\"button.brush.replace_block.name\"","storage": "worldtool:storage","color":"gold","hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush.replace_block.description\"","storage":"worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/select_block/secondary/select"}},{"nbt":"Translation.\"button.brush.select_brush.name\"","storage": "worldtool:storage","color":"light_purple","hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush.select_brush.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/select_brush/menu"}}]
