...
execute store result score #temp worldtool run data get storage worldtool:storage Temp.ItemData.WorldTool.BrushSettings.MaxSize
execute store result score #temp2 worldtool run data get storage worldtool:storage Temp.ItemData.WorldTool.BrushSettings.MinSize
...
execute unless score #temp worldtool matches 0 unless score #temp2 worldtool matches 0 if score #brushSize_temp worldtool > #temp worldtool run function worldtool:modify_item/brush_tool/settings/set_size
...
execute unless score #temp worldtool matches 0 unless score #temp2 worldtool matches 0 if score #brushSize_temp worldtool < #temp2 worldtool run function worldtool:modify_item/brush_tool/settings/set_size
...
execute if entity @s[tag=wt.brush.circle] run tag @s add wt.setting.axis
execute if entity @s[tag=wt.setting.flat,predicate=worldtool:brush_tool/settings/flat] run tag @s add wt.setting.axis
...
execute if score $brushToolPlugins worldtool matches 1.. run function #worldtool:hooks/ui_brush/menu/add_tags

# Display the selected brush
execute if entity @s[tag=wt.brush.none] run tellraw @s {"nbt":"Translation.\"info.selected_brush.none\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.paint] run tellraw @s {"nbt":"Translation.\"info.selected_brush.paint\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.place] run tellraw @s {"nbt":"Translation.\"info.selected_brush.place\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.replace] run tellraw @s {"nbt":"Translation.\"info.selected_brush.replace\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.sphere] run tellraw @s {"nbt":"Translation.\"info.selected_brush.sphere\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.circle] run tellraw @s {"nbt":"Translation.\"info.selected_brush.circle\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.structure] run tellraw @s {"nbt":"Translation.\"info.selected_brush.structure\"","storage": "worldtool:storage","color":"yellow","bold":true}
execute if entity @s[tag=wt.brush.greenery] run tellraw @s {"nbt":"Translation.\"info.selected_brush.greenery\"","storage": "worldtool:storage","color":"yellow","bold":true}
function #worldtool:hooks/ui_brush/menu/display_brush

function worldtool:technical/common/get_item_data
execute if entity @s[tag=wt.setting.brush_size] run tellraw @s ["",{"nbt":"Translation.\"label.brush_size\"","storage": "worldtool:storage","color":"dark_aqua"},{"nbt":"Translation.\"button.decrease.name\"","storage": "worldtool:storage","color":"light_purple","bold":true,"hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush_size.decrease.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/settings/brush_size_decrease"}},{"nbt":"Temp.ItemData.WorldTool.BrushSettings.Size","storage": "worldtool:storage"},{"nbt":"Translation.\"button.increase.name\"","storage": "worldtool:storage","color":"light_purple","bold":true,"hoverEvent":{"action":"show_text","contents": {"nbt":"Translation.\"button.brush_size.increase.description\"","storage": "worldtool:storage"}},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_brush/settings/brush_size_increase"}}]
...
execute if entity @s[tag=wt.setting.greenery_rate] run tellraw @s ["",{"nbt":"Translation.\"label.greenery.rate\"","storage": "worldtool:storage","color": "green","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"label.greenery.rate.description\"","storage": "worldtool:storage"}}},{"nbt":"Translation.\"button.decrease.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt": "Translation.\"button.greenery.rate.decrease.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_brush/settings/greenery_rate_decrease"}},{"nbt":"SelectedItem.tag.WorldTool.BrushSettings.GreeneryRate","entity": "@s","color": "gold"},{"nbt":"Translation.\"button.increase.name\"","storage": "worldtool:storage","color": "light_purple","bold": true,"hoverEvent": {"action": "show_text","contents": {"nbt": "Translation.\"button.greenery.rate.increase.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_brush/settings/greenery_rate_increase"}}]
...
tellraw @s ["\n",{"nbt":"Translation.\"button.options.name\"","storage": "worldtool:storage","color": "#006fff","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.options.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_brush/options/menu"}}]
...
execute if entity @s[tag=wt.brush.structure] if data storage worldtool:storage Temp.ItemData.WorldTool.BrushSettings.Structure run tellraw @s ["",{"nbt":"Translation.\"info.selected_structure\"","storage": "worldtool:storage"},{"nbt":"Temp.ItemData.WorldTool.BrushSettings.Structure","storage": "worldtool:storage","color": "green"}]
...
execute if score $brushToolPlugins worldtool matches 1.. run function #worldtool:hooks/ui_brush/menu/remove_tags
