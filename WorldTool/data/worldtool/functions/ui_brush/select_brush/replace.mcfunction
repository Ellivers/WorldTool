...
execute unless predicate worldtool:brush_tool/settings/replace/exclude unless predicate worldtool:brush_tool/settings/replace/normal run function worldtool:ui_brush/select_block/replace/1
