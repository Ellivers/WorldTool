...
execute if entity @s[tag=wt.select_block.brush.replace] run data modify storage worldtool:storage Temp.ReplaceBlock set from storage worldtool:storage Temp.Block
execute if entity @s[tag=wt.select_block.brush.replace] run data remove storage worldtool:storage Temp.Block

execute if entity @s[tag=!wt.select_block.brush.replace] run item modify entity @s weapon.mainhand worldtool:brush_tool/set_block
execute if entity @s[tag=wt.select_block.brush.replace] run item modify entity @s weapon.mainhand worldtool:brush_tool/set_replace_block
