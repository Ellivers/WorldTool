...
execute if entity @s[tag=wt.select_block.brush.secondary] run data modify storage worldtool:storage Temp.SecondaryBlock set from storage worldtool:storage Temp.Block
execute if entity @s[tag=wt.select_block.brush.secondary] run data remove storage worldtool:storage Temp.Block

execute if entity @s[tag=!wt.select_block.brush.secondary] run item modify entity @s weapon.mainhand worldtool:brush_tool/set_block
