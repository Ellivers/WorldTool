...
tellraw @s ["\n",{"nbt":"Translation.\"button.reset.name\"","storage": "worldtool:storage","color": "light_purple","hoverEvent": {"action": "show_text","value": {"nbt":"Translation.\"button.brush.structure_offset.reset.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_brush/structure_offset/reset"}}]
tellraw @s {"nbt":"Translation.\"button.brush.structure_offset.set_offset.name\"","storage": "worldtool:storage","color": "aqua","hoverEvent": {"action": "show_text","value": {"nbt":"Translation.\"button.brush.structure_offset.set_offset.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "suggest_command","value": "/summon item ~ ~ ~ {Tags:[worldtool,wt.selected_data],PickupDelay:32767s,Item:{id:\"minecraft:stick\",Count:1b,tag:{WorldTool:{ posX:0, posY:0, posZ:0 }}}}"}}
