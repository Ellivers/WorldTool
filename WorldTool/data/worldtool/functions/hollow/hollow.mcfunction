...
execute if score $drawingposZ worldtool = $pos2z worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block
execute if score $drawingposZ worldtool = $pos1z worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block

execute if score $drawingposY worldtool = $pos2y worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block
execute if score $drawingposY worldtool = $pos1y worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block

execute if score $drawingposX worldtool = $pos2x worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block
execute if score $drawingposX worldtool = $pos1x worldtool unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all run function worldtool:block_place/place_block
