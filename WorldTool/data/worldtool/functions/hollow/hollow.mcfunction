...
execute if score $drawingposX worldtool < $pos2x worldtool unless score #blockschecked worldtool >= $hollowBlocksPerTick worldtool run function worldtool:hollow/x
execute if score $drawingposX worldtool > $pos2x worldtool unless score #blockschecked worldtool >= $hollowBlocksPerTick worldtool run function worldtool:hollow/-x

execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool < $pos2y worldtool unless score #blockschecked worldtool >= $hollowBlocksPerTick worldtool run function worldtool:hollow/y
execute if score $drawingposX worldtool = $pos2x worldtool if score $drawingposY worldtool > $pos2y worldtool unless score #blockschecked worldtool >= $hollowBlocksPerTick worldtool run function worldtool:hollow/-y
