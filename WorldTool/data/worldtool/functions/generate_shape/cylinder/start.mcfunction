...
execute unless predicate worldtool:shapes/keep run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["wt_drawer","worldtool","wt_cylindergen","wt_circlegen","wt_generator"]}
execute if predicate worldtool:shapes/keep run summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["wt_drawer","worldtool","wt_cylindergen","wt_circlegen","keep","wt_generator"]}
