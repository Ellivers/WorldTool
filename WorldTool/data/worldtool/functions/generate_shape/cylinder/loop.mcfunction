...
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 1 at @s run tp ~ ~1 ~
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 2 at @s run tp ~ ~-1 ~
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 3 at @s run tp ^-1 ^ ^
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 4 at @s run tp ^1 ^ ^
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 5 at @s run tp ^1 ^ ^
execute unless score #shapeRotated worldtool matches 1 if score #axisTemp worldtool matches 6 at @s run tp ^-1 ^ ^
...
execute if score #currentHeight worldtool >= #maxHeightMinusOne worldtool run scoreboard players set #hollowTemp worldtool 0
