...
execute if score #shapeHollow worldtool matches 1 if score #circleMode worldtool matches 1 if score #shapeDegrees worldtool matches 360.. unless score #temp worldtool >= #shapeRadius worldtool run scoreboard players set #placeShapeBlock worldtool 0
execute if score #shapeHollow worldtool matches 1 if score #circleMode worldtool matches 1 unless score #shapeDegrees worldtool matches 360.. unless score #temp worldtool >= #shapeRadius worldtool unless score #circleRotations worldtool matches 1 unless score #circleRotations worldtool >= #rotations worldtool run scoreboard players set #placeShapeBlock worldtool 0
