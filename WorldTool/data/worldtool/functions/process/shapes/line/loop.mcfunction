...
execute if score #shapeHollow worldtool matches 1 if score #shapeDegrees worldtool matches 360.. unless score #lengthReached worldtool matches 0 unless score #length_temp worldtool >= #fullLength worldtool unless score #temp worldtool >= #radius_temp worldtool run scoreboard players set #placeShapeBlock worldtool 0
execute if score #shapeHollow worldtool matches 1 unless score #shapeDegrees worldtool matches 360.. unless score #lengthReached worldtool matches 0 unless score #length_temp worldtool >= #fullLength worldtool unless score #temp worldtool >= #radius_temp worldtool unless score #circleRotations worldtool matches 1 unless score #circleRotations worldtool >= #rotations worldtool run scoreboard players set #placeShapeBlock worldtool 0
