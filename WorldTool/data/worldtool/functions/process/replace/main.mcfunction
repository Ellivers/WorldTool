...
execute if entity @s[tag=wt.process.replace.normal] unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all if blocks ~ ~ ~ ~ ~ ~ 2 1 13 all run function worldtool:process/place_block.primary
execute if entity @s[tag=wt.process.replace.exclude] unless blocks ~ ~ ~ ~ ~ ~ 0 1 13 all unless blocks ~ ~ ~ ~ ~ ~ 2 1 13 all run function worldtool:process/place_block.primary
