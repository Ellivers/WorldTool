...
execute if score #temp2 worldtool matches 1 unless score #temp worldtool >= #diffY worldtool positioned ~-1 ~ ~ run function worldtool:process/smooth/directions/west/apply
execute if score #temp2 worldtool matches -1 unless score #temp worldtool <= #diffY worldtool positioned ~1 ~ ~ run function worldtool:process/smooth/directions/west/apply
