...
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.z] positioned ^ ^ ^-1 run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.-x,tag=!wt.process.2d_fill.heading.z] positioned ^1 ^ ^-1 run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.-x] positioned ^1 ^ ^ run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.-x,tag=!wt.process.2d_fill.heading.-z] positioned ^1 ^ ^1 run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.-z] positioned ^ ^ ^1 run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.x,tag=!wt.process.2d_fill.heading.-z] positioned ^-1 ^ ^1 run function worldtool:process/2d_fill/check/is_wall
execute if score #temp worldtool matches 0 if entity @s[tag=!wt.process.2d_fill.heading.x] positioned ^-1 ^ ^ run function worldtool:process/2d_fill/check/is_wall
