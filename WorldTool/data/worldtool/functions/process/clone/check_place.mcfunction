...
execute if entity @s[tag=!wt.process.filter.normal,tag=!wt.process.filter.exclude] unless blocks ~ ~ ~ ~ ~ ~ 27451 1 19 all run function worldtool:process/place_block.primary
