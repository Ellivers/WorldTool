...
# Error that occurs when the process attempts to load a template too close to out of bounds
...
execute as @a if score @s wt.ID = #ID_temp worldtool run function worldtool:ui/error/out_of_bounds_place
