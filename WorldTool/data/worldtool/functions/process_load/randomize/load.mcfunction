...
summon minecraft:area_effect_cloud ~ ~ ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["random1","wt_finish_other","wt_no_done_message","wt_no_reset","worldtool"], UUID:[I; 901884776, -1655959061, -1464663486, -1408040957]}
