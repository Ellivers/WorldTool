...
execute if entity @s[tag=!from_cmd] if score $functionRunning worldtool matches 1 as @a[tag=random_2] if score @s wt_ID = #ID_temp worldtool at @s run function worldtool:ui_general/random/place_done
