...
execute if entity @s[tag=!wt_no_output] run function worldtool:process_done/finish.wed
...
execute if entity @s[tag=!from_cmd,tag=!wt_no_reset] as @a if score @s wt_ID = #ID_temp worldtool at @s run function worldtool:process_done/finish
