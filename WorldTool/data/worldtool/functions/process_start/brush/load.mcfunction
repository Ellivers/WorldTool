...
execute if predicate worldtool:brush_tool/brushes/none run tellraw @s {"nbt":"Translation.\"error.no_brush\"","storage": "worldtool:storage","interpret": true,"color": "gold"}
