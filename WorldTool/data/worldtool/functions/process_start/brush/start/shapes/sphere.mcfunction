...
execute unless score #brushSize_temp worldtool matches ..1 if predicate worldtool:brush_tool/settings/hollow run function worldtool:process_start/brush/start/shapes/sphere_hollow
