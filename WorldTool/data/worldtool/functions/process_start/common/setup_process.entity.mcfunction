...
execute if entity @s[tag=wt.pos1] run data modify storage worldtool:storage Processes[0].Positions.1 set from entity @s Pos
execute if entity @s[tag=wt.pos2] run data modify storage worldtool:storage Processes[0].Positions.2 set from entity @s Pos
