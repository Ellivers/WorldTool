...
# Makes the process start from the top
...
execute if score #temp2 worldtool matches 1 if entity @s[tag=wt.process.clone] as 9880ccfe-fdf6-4538-838a-ddc75a54608e run function worldtool:ui_general/clone/set_reciever_at_top

function #worldtool:addon/process_start/start_from_top
