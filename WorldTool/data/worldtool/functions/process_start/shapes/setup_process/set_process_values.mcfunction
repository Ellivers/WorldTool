# Called by shape process setup functions
...
execute if predicate worldtool:shape_tool/settings/continuous_place run data modify storage worldtool:storage Processes[0].Tags append value "wt.no_message"
