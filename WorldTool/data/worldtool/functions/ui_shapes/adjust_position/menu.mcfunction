# Called by worldtool:ui_shapes/adjust_position/load
...
execute if score #pos1xt worldtool matches -2147483648.. run tellraw @s ["",{"nbt":"Translation.\"info.measure.position\"","storage":"worldtool:storage","interpret":true}," ",{"nbt":"Translation.\"button.teleport.name\"","storage": "worldtool:storage","color": "#d534eb","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.teleport.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_shapes/adjust_position/tp"}},"\n"]
execute unless score #pos1xt worldtool matches -2147483648.. run tellraw @s [{"nbt":"Translation.\"info.pos_unset\"","storage": "worldtool:storage","color": "red"},"\n"]

function worldtool:input_data/message/set_shape_position_step_size
...
function worldtool:input_data/message/set_shape_position
