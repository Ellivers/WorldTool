...
execute if data entity @s {Item:{tag:{Type:6b}}} run function worldtool:ui_brush/dropped
execute if data entity @s {Item:{tag:{Type:7b}}} run function worldtool:ui_shapes/dropped
