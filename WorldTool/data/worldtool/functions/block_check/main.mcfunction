...
execute unless block ~1 ~ ~ minecraft:air at @a[tag=placing_fill] if score @s wt_ID = @p wt_ID as @p run function worldtool:load_function/start_check1
...
execute unless block ~1 ~ ~ minecraft:air at @a[tag=replacing_fill2] if score @s wt_ID = @p wt_ID as @p run function worldtool:load_function/start_check1
...
execute unless block ~1 ~ ~ minecraft:air at @a[tag=destroy_select] if score @s wt_ID = @p wt_ID as @p run function worldtool:ui/destroy/start
execute unless block ~-1 ~ ~ minecraft:air at @a[tag=d_replacing_fill1] if score @s wt_ID = @p wt_ID as @p run function worldtool:ui/destroy/replace/select_replace2
execute unless block ~1 ~ ~ minecraft:air at @a[tag=d_replacing_fill2] if score @s wt_ID = @p wt_ID as @p run function worldtool:ui/destroy/replace/start_replace