...
execute if score @s worldtool matches 2 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/tall_grass
...
execute if score @s worldtool matches 14 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/lilac
execute if score @s worldtool matches 15 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/rose_bush
execute if score @s worldtool matches 16 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/peony