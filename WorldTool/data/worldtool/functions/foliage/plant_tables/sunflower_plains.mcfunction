...
execute if score @s worldtool matches 9..10 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/tall_grass
execute if score @s worldtool matches 11 if block ~ ~1 ~ #worldtool:air_blocks run function worldtool:foliage/double_plants/sunflower
