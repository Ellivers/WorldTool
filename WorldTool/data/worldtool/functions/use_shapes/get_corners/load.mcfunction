# Called by worldtool:use_shapes/setup_process/cylinder and worldtool:use_shapes/setup_process/cone
...
execute if predicate worldtool:shape_tool/settings/orientation/up run function worldtool:use_shapes/get_corners/up
execute if predicate worldtool:shape_tool/settings/orientation/down run function worldtool:use_shapes/get_corners/down
execute if predicate worldtool:shape_tool/settings/orientation/north run function worldtool:use_shapes/get_corners/north
execute if predicate worldtool:shape_tool/settings/orientation/south run function worldtool:use_shapes/get_corners/south
execute if predicate worldtool:shape_tool/settings/orientation/west run function worldtool:use_shapes/get_corners/west
execute if predicate worldtool:shape_tool/settings/orientation/east run function worldtool:use_shapes/get_corners/east
