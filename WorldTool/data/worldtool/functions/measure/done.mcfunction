execute if entity @s[tag=!nomeasuredonemessageplzthx] run function worldtool:ui/clear_chat
...
execute if entity @s[tag=random_2] run function worldtool:load_process/load_random_check.2
execute if entity @s[tag=wt_measuring_area] run function worldtool:load_process/start_check2
execute if entity @s[tag=wt_measuring_area_clone] run function worldtool:ui/clone/start.check2
