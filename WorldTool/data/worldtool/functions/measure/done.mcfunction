...
execute if entity @s[tag=wt_random_2] run function worldtool:process_load/randomize/check2
execute if entity @s[tag=wt_measuring_area] run function worldtool:process_load/start_check2
