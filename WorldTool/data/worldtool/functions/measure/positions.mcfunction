...
tellraw @s {"nbt":"Translation.\"info.measure.position.1\"","storage":"worldtool:storage","interpret":true}
tellraw @s {"nbt":"Translation.\"info.measure.position.2\"","storage":"worldtool:storage","interpret":true}
