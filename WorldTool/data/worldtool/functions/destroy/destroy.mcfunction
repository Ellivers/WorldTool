...
#execute unless entity @s[tag=!replacefill,tag=!replacefill_reversed] if block ~ ~ ~ minecraft:structure_void run function worldtool:place_block
...
execute if block ~ ~ ~ minecraft:structure_void run function worldtool:place_block
...
execute if score #blockschecked worldtool >= $destroyedBlocksPerTick worldtool run schedule function worldtool:load2_fill 1t