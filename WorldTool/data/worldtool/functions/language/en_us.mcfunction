...
data modify storage worldtool:storage Translation."label.shapes.degrees2.name" set value "Degrees 2: "
data modify storage worldtool:storage Translation."label.shapes.degrees2.description" set value "How many degrees of a circle the circles that make up the sphere are drawn. 360 degrees is a full circle."
