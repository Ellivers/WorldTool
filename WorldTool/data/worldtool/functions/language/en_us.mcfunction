...
data modify storage worldtool:storage Translation."label.replace_mode" set value "Replace mode: "
data modify storage worldtool:storage Translation."label.replace_mode.description" set value "Toggle between choosing a block to filter/replace (Normal), and choosing a block to NOT filter/replace (Exclude)"
data modify storage worldtool:storage Translation."replace_mode.normal" set value "[Normal]"
data modify storage worldtool:storage Translation."replace_mode.exclude" set value "[Exclude]"
...
data modify storage worldtool:storage Translation."button.clone.include_entities.off" set value "[Include Entities: Off]"
data modify storage worldtool:storage Translation."button.clone.include_entities.on" set value "[Include Entities: On]"
data modify storage worldtool:storage Translation."button.clone.include_entities.description" set value "If enabled, clones entities in the source area as well"
...
data modify storage worldtool:storage Translation."clone_mode.standard.description" set value "All cloning options, and rotation and mirror directions/combinations. Does not support cloning entities."
data modify storage worldtool:storage Translation."clone_mode.template.description" set value "Supports proper block rotation and cloning entities, but lacks Filter, Keep support, and certain rotation and mirror directions/combinations. Can be faster than Standard mode."
