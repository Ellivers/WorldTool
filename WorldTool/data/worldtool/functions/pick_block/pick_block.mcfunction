...
execute at @s[tag=!pick_primary_block,tag=!pick_secondary_block] as @e[type=minecraft:area_effect_cloud,tag=worldtool,tag=wt_check] if score #ID_temp worldtool = @p wt_ID at @s run function worldtool:pick_block/pick_block2
