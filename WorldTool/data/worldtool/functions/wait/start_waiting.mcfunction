...
tellraw @s [{"text": "\n\n\nAnother process is currently running. The function you've \nselected will automagically start when the other process ends.","color":"gold"},{"text": "\n[Kill processes]  ","color":"red","hoverEvent": {"action": "show_text","value": "Kill all running processes"},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/menus/options/settings/kill_processes"}},{"text":"[Close]","color":"white","hoverEvent":{"action":"show_text","value":"Close all menus and cancel"},"clickEvent":{"action":"run_command","value":"/function worldtool:ui_general/cancel"}}]
