...
execute if entity @s[tag=wt.receiver_marker] run data modify storage worldtool:storage Processes[0].Positions.Secondary set from entity @s Pos
kill @s[tag=wt.receiver_marker]
