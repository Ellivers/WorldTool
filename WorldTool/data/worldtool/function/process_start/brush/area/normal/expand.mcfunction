# Called recursively and by worldtool:process_start/brush/area/normal/load
...
execute if score #temp3 worldtool < #brushSize_temp worldtool run function worldtool:process_start/brush/area/normal/expand
