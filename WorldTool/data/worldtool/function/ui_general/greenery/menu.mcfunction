...
function worldtool:input_data/message/greenery_rate
tellraw @s[tag=!wt.greenery.remove_current,tag=!wt.two_block_query.normal,tag=!wt.two_block_query.exclude] [{"nbt":"Translation.\"button.greenery.remove_current.off\"","storage": "worldtool:storage","color": "light_purple","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.greenery.remove_current.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/greenery/settings/remove_current_toggle"}}," ",{"nbt":"Translation.\"button.replace.off_more\"","storage": "worldtool:storage","color": "gold","hoverEvent": {"action": "show_text","contents": {"nbt":"Translation.\"button.greenery.replace.description\"","storage": "worldtool:storage"}},"clickEvent": {"action": "run_command","value": "/function worldtool:ui_general/greenery/replace_on"}}]
...
tellraw @s[tag=wt.greenery.source.plains] ["",{"nbt":"Translation.\"info.greenery.current_plant_source\"","storage": "worldtool:storage"},{"nbt":"Translation.\"plant_source.plains\"","storage": "worldtool:storage","color": "#13c4d1"}]
tellraw @s[tag=wt.greenery.source.sunflower_plains] ["",{"nbt":"Translation.\"info.greenery.current_plant_source\"","storage": "worldtool:storage"},{"nbt":"Translation.\"plant_source.sunflower_plains\"","storage": "worldtool:storage","color": "#13c4d1"}]
tellraw @s[tag=wt.greenery.source.flower_forest] ["",{"nbt":"Translation.\"info.greenery.current_plant_source\"","storage": "worldtool:storage"},{"nbt":"Translation.\"plant_source.flower_forest\"","storage": "worldtool:storage","color": "#13c4d1"}]
tellraw @s[tag=wt.greenery.source.taiga] ["",{"nbt":"Translation.\"info.greenery.current_plant_source\"","storage": "worldtool:storage"},{"nbt":"Translation.\"plant_source.taiga\"","storage": "worldtool:storage","color": "#13c4d1"}]
tellraw @s[tag=wt.greenery.source.desert] ["",{"nbt":"Translation.\"info.greenery.current_plant_source\"","storage": "worldtool:storage"},{"nbt":"Translation.\"plant_source.desert\"","storage": "worldtool:storage","color": "#13c4d1"}]
