...
execute if score #temp2 worldtool matches 1 unless score #temp worldtool > #diff worldtool positioned ~ ~ ~-1 run function worldtool:process/smooth/directions/north/apply
execute if score #temp2 worldtool matches -1 unless score #temp worldtool <= #diff worldtool positioned ~ ~ ~1 run function worldtool:process/smooth/directions/north/apply
