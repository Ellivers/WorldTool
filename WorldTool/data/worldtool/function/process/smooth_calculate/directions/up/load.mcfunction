...
execute unless score #temp worldtool matches 0 run data modify storage worldtool:storage Processes[-1].Generated.Up append value {Pos:[0,0,0],Diff:0}
execute unless score #temp worldtool matches 0 store result storage worldtool:storage Processes[-1].Generated.Up[-1].Pos[0] int 1 run scoreboard players get #processPosX worldtool
execute unless score #temp worldtool matches 0 store result storage worldtool:storage Processes[-1].Generated.Up[-1].Pos[1] int 1 run scoreboard players get #processPosY worldtool
execute unless score #temp worldtool matches 0 store result storage worldtool:storage Processes[-1].Generated.Up[-1].Pos[2] int 1 run scoreboard players get #processPosZ worldtool
execute unless score #temp worldtool matches 0 store result storage worldtool:storage Processes[-1].Generated.Up[-1].Diff int 1 run scoreboard players get #temp worldtool
