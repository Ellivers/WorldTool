...
data modify block ~ ~ ~ name set from storage worldtool:storage Processes[-1].Input.AreaList[0].TemplateList[0].Slot
data modify block ~ ~ ~ {} merge from storage worldtool:storage Processes[-1].Input.AdditionalData
