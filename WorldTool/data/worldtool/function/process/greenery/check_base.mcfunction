...
execute if entity @s[tag=wt.process.greenery.base.desert] if block ~ ~ ~ #worldtool:sand run function worldtool:process/greenery/check_chance
execute if entity @s[tag=wt.process.greenery.base.all] run function worldtool:process/greenery/check_chance
