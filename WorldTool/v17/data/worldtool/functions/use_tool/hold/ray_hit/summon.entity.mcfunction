...
data merge entity @s {active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:0b}],NoAI:1b,Silent:1b,Glowing:1b,Invulnerable:1b,DeathLootTable:"minecraft:empty",Tags:["worldtool","wt.highlight_entity","smithed.strict"],AbsorptionAmount:2e900f}
